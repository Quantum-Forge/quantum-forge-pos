            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>{{ __('product_cart.discount_type') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        @if($discount_type[$cart_item->id] == 'percentage')
                            <label>{{ __('product_cart.discount') }}(%) <span class="text-danger">*</span></label>
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click="setProductDiscount('{{ $cart_item->rowId }}', {{ $cart_item->id }})" type="button" class="btn btn-primary">{{ __('form.save_changes') }}</button>
                </div>
            </div>
        </div>
    </div>
