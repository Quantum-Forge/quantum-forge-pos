...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('products.edit.short_title') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('products.edit.title') }} <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="product_name">{{ __('products.edit.product_name') }} <span
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="product_code">{{ __('products.edit.code') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="category_id">{{ __('products.edit.category') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">{{ __('products.edit.barcode_symbology') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_cost">{{ __('products.edit.cost') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_price">{{ __('products.edit.price') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_quantity">{{ __('products.edit.quantity') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">{{ __('products.edit.alert_quantity') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_order_tax">{{ __('products.edit.tax') }} (%)</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_tax_type">{{ __('products.edit.tax_type') }}</label>
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            <option value="" selected>N/A</option>
                                            <option {{ $product->product_tax_type == 1 ? 'selected' : '' }}
                                                value="1">{{ __('products.edit.exclude_ppn') }}</option>
                                            <option {{ $product->product_tax_type == 2 ? 'selected' : '' }}
                                                value="2">{{ __('products.edit.include_ppn') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">{{ __('products.edit.unit') }} <i
                                                class="bi bi-question-circle-fill text-info" data-toggle="tooltip"
                                                data-placement="top" title="{{ __('products.edit.unit_text') }}"></i>
                                            <span class="text-danger">*</span></label>
                                        <select class="form-control" name="product_unit" id="product_unit" required>
                                            <option value="" selected>{{ __('products.edit.select_unit') }}</option>
                            ...
                            <div class="form-group">
                                <label for="product_note">{{ __('products.edit.note') }}</label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">{{ __('products.edit.product_images') }} <i
                                        class="bi bi-question-circle-fill text-info" data-toggle="tooltip"
                                        data-placement="top"
