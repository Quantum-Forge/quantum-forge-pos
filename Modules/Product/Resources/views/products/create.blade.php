...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('products.create.short_title') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('products.create.title') }} <i
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_name">{{ __('products.create.product_name') }} <span
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_code">{{ __('products.create.code') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label for="category_id">{{ __('products.create.category') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <select class="form-control" name="category_id" id="category_id" required>
                                            <option value="" selected disabled>
                                                {{ __('products.create.select_category') }}</option>
                                        ...
                                        <div class="input-group-append d-flex">
                                            <button data-toggle="modal" data-target="#categoryCreateModal"
                                                ...
                                                {{ __('products.create.add_category') }}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">{{ __('products.create.barcode_symbology') }} <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control" name="product_barcode_symbology" id="barcode_symbology"
                                            required>
                                            <option value="" selected disabled>
                                                {{ __('products.create.select_symbology') }}</option>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_cost">{{ __('products.create.cost') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_price">{{ __('products.create.price') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_quantity">{{ __('products.create.quantity') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">{{ __('products.create.alert_quantity') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_order_tax">{{ __('products.create.tax') }}
                                            (%)</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_tax_type">{{ __('products.create.tax_type') }}</label>
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            <option value="" selected>{{ __('products.create.select_tax_type') }}
                                            </option>
                                            <option value="1">{{ __('products.create.exclude_ppn') }}</option>
                                            <option value="2">{{ __('products.create.include_ppn') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="product_note">{{ __('products.create.note') }}</label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">{{ __('products.create.product_images') }} <i
                                        class="bi bi-question-circle-fill text-info" data-toggle="tooltip"
                                        data-placement="top"
