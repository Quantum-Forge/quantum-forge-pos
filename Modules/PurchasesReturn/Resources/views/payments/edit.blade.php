...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('purchase_return.edit') }} {{ __('sidebar.payment') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('purchase_return.update_payment') }} <i
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="due_amount">{{ __('purchase_return.due_amount') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="amount">{{ __('purchase_return.amount') }} <span
                                                class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                @foreach (App\Interface\PaymentMethod::getAllPaymentMethod() as $item)
                                                    <option
                                                        {{ $purchaseReturnPayment->payment_method == $item->displayName() ? 'selected' : '' }}
