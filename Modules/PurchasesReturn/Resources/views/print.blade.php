...
<head>
    ...
    <title>{{ __('purchase_return.purchase_return_details') }}</title>
            ...
            <div class="col-xs-12">
                <div style="text-align: center;margin-bottom: 25px;">
                    ...
                    <h4 style="margin-bottom: 20px;">
                        <span>{{ __('purchase_return.reference') }}::</span>
                        <strong>{{ $purchase_return->reference }}</strong>
                    </h4>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-xs-4 mb-3 mb-md-0">
                                <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">
                                    {{ __('purchase_return.company_info') }}:</h4>
                            ...
                            <div class="col-xs-4 mb-3 mb-md-0">
                                <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">
                                    {{ __('purchase_return.supplier_info') }}:</h4>
                            ...
                            <div class="col-xs-4 mb-3 mb-md-0">
                                <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">
                                    {{ __('purchase_return.invoice_info') }}:</h4>
                                <div>{{ __('purchase_return.invoice') }}:
                                    <strong>INV/{{ $purchase_return->reference }}</strong>
                                </div>
