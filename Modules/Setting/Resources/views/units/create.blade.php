                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="short_name">{{ __('setting.unit.add_unit') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-12 d-flex justify-content-end">
                                    <div class="form-group">
                                        <button class="btn btn-primary">{{ __('setting.unit.create_unit') }} <i class="bi bi-check"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
