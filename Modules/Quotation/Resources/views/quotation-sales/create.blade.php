...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('sidebar.make_sale') }}</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="sale-form" action="{{ route('sales.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            ...
                                            <option value="Shipped">{{ __('quotation.shipped') }}</option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">{{ __('quotation.amount_received') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('quotation.create_sale') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
