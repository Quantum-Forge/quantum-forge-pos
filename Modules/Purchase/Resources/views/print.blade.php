...
<head>
    ...
    <title>{{ __('purchase.purchase_details') }}</title>
            ...
            <div class="col-xs-12">
                <div style="text-align: center;margin-bottom: 25px;">
                    ...
                    <h4 style="margin-bottom: 20px;">
                        <span>{{ __('purchase.reference') }}::</span> <strong>{{ $purchase->reference }}</strong>
                    </h4>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-xs-4 mb-3 mb-md-0">
                                <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">
                                    {{ __('purchase.invoice_info') }}:</h4>
                                <div>{{ __('purchase.invoice') }}: <strong>INV/{{ $purchase->reference }}</strong>
                                </div>
